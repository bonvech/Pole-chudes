...
for i in range(v):
    ...
    if len(o1) == 1 and ord(o1) > (ord('а') - 1) and ord(o1) < (ord('я') + 1):
        if o1 in b:
            ...
            print('Попрубуйте ввести заново. Напоминаем вам нужно ввести одну маленькую букву русского алфавита, которую вы еще не вводили е = ё. Или угадать слово. Введите #сдаться чтобы сдаться. И #help чтобы узнать правтла и команды.')
        ...
        print('Напоминаем вам нужно ввести одну маленькую букву русского алфавита, которую вы еще не вводили е = ё. Или угадать слово. Введите #сдаться чтобы сдаться. И #help чтобы узнать правтла и команды.')
    elif '#сдаться' in o1:
